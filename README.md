...
Se pone a disposición el trabajo de asesoría estadística 1, por parte Lambda Analytics. lo que incluye\begin{enumerate}
\item Informe que documenta el proceder estadístico y resultados solicitados por la contraparte
\item Dashboard interactivo con el cual el receptor final puede observar de primera mano como se comportan las regiones: \url{https://lambdaanalytics.shinyapps.io/dashboard/}
\item Entrega y transparencia de las bases de datos, procesos estadísticos y resultados.
\end{enumarete}
